...
void sm_vehicle_2axle_heave_roll_836bb176_1_perturbSimJointPrimitiveState(const
...
void sm_vehicle_2axle_heave_roll_836bb176_1_perturbFlexibleBodyState(const void *
...
void sm_vehicle_2axle_heave_roll_836bb176_1_constructStateVector(const void
...
void sm_vehicle_2axle_heave_roll_836bb176_1_extractSolverStateVector(const void *
...
boolean_T sm_vehicle_2axle_heave_roll_836bb176_1_isPositionViolation(const void *
  mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
...
boolean_T sm_vehicle_2axle_heave_roll_836bb176_1_isVelocityViolation(const void *
  mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags, const
  double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId sm_vehicle_2axle_heave_roll_836bb176_1_projectStateSim(const void
  *mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags,
  const int *modeVector, double *state, void *neDiagMgr0)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
  const int *rtdvi = rtdv->mInts.mValues;
...
void sm_vehicle_2axle_heave_roll_836bb176_1_computeConstraintError(const void
...
PmfMessageId
  sm_vehicle_2axle_heave_roll_836bb176_1_performJointDisToNormModeChange(const
...
void sm_vehicle_2axle_heave_roll_836bb176_1_onModeChangedCutJoints(const void
