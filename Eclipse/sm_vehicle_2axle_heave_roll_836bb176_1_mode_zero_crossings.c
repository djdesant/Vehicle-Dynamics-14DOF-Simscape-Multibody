...
const NeZCData *sm_vehicle_2axle_heave_roll_836bb176_1_ZCData = NULL;
PmfMessageId sm_vehicle_2axle_heave_roll_836bb176_1_computeAsmModeVector(const
...
PmfMessageId sm_vehicle_2axle_heave_roll_836bb176_1_computeSimModeVector(const
  double *input, const double *inputDot, const double *inputDdot, int
  *modeVector, double *errorResult, NeuDiagnosticManager *neDiagMgr)
{
  (void) input;
...
PmfMessageId sm_vehicle_2axle_heave_roll_836bb176_1_computeZeroCrossings(const
