...
#include "nesl_rtw.h"
#include "sm_vehicle_2axle_heave_roll_836bb176_1.h"
#include "sm_vehicle_2axle_heave_roll_836bb176_1_gateway.h"

void sm_vehicle_2axle_heave_roll_836bb176_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 1, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.001, 0, 0, 0, 0, (SscLoggingSetting) 1, 624834411, 1,
    0, 0, };
  ...
  NeSolverParameters solverparams = { 0, 0, 1, 0, 0, 0.001, 1e-06, 1e-09, 0, 0,
    ...
    0.001, 0, 3, 2, 0, 2, (NeLinearAlgebraChoice) 1, 0,
    (NeEquationFormulationChoice) 0, 1024, 1, 0.001, (NePartitionStorageMethod)
    0, 1024, (NePartitionMethod) 1, 0, (NeMultibodyLocalSolverChoice) 0, 0.001,
  };
  ...
  sm_vehicle_2axle_heave_roll_836bb176_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group(
    "sm_vehicle_2axle_heave_roll/Vehicle/World/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
