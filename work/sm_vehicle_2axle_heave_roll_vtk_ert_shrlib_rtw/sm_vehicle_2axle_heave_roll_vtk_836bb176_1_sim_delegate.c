...
void sm_vehicle_2axle_heave_roll_vtk_836bb176_1_perturbFlexibleBodyState(const
  void *mech, size_t stageIdx, double mag, boolean_T doPerturbVelocity, double
  *state)
{
  (void) mech;
  (void) stageIdx;
...
void sm_vehicle_2axle_heave_roll_vtk_836bb176_1_constructStateVector(const void *
...
void sm_vehicle_2axle_heave_roll_vtk_836bb176_1_extractSolverStateVector(const
  void *mech, const double *fullState, double *solverState)
{
  (void) mech;
...
boolean_T sm_vehicle_2axle_heave_roll_vtk_836bb176_1_isPositionViolation(const
...
boolean_T sm_vehicle_2axle_heave_roll_vtk_836bb176_1_isVelocityViolation(const
  void *mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags,
  const double *state, const int *modeVector)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
...
PmfMessageId sm_vehicle_2axle_heave_roll_vtk_836bb176_1_projectStateSim(const
  void *mech, const RuntimeDerivedValuesBundle *rtdv, const int *eqnEnableFlags,
...
void sm_vehicle_2axle_heave_roll_vtk_836bb176_1_computeConstraintError(const
  void *mech, const RuntimeDerivedValuesBundle *rtdv, const double *state, const
  int *modeVector, double *error)
{
  const double *rtdvd = rtdv->mDoubles.mValues;
  const int *rtdvi = rtdv->mInts.mValues;
  (void) mech;
...
void sm_vehicle_2axle_heave_roll_vtk_836bb176_1_onModeChangedCutJoints(const
  void *mech, const int *prevModeVector, const int *modeVector, double *state)
{
  (void) mech;
  (void) prevModeVector;
  (void) modeVector;
