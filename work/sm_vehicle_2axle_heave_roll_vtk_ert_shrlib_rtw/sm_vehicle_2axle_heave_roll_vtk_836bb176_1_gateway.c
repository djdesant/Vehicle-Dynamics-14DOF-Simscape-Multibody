...
#include "nesl_rtw.h"
#include "sm_vehicle_2axle_heave_roll_vtk_836bb176_1.h"
#include "sm_vehicle_2axle_heave_roll_vtk_836bb176_1_gateway.h"

void sm_vehicle_2axle_heave_roll_vtk_836bb176_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 1, 0.001, 0.001, 0.001, 0, 0,
    (NeModifyAbsTol) 0, 0.001, 0, 0, 0, 0, (SscLoggingSetting) 1, 626481379, 1,
    0, 0, };
  ...
  sm_vehicle_2axle_heave_roll_vtk_836bb176_1_dae(&dae,
    &modelparams,
    &solverparams);
