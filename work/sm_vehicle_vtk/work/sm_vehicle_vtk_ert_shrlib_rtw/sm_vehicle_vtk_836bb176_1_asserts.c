...
void sm_vehicle_vtk_836bb176_1_validateRuntimeParameters(const double *rtp,
  int32_T *satFlags)
{
  boolean_T bb[20];
  double xx[1];
...
const NeAssertData sm_vehicle_vtk_836bb176_1_assertData[20] = {
  { "sm_vehicle_vtk/Vehicle/Body to World/Body World Joint", 0, 0,
    "Vehicle.Body_to_World.Body_World_Joint", "", false,
  ...
  { "sm_vehicle_vtk/Vehicle/Revolute FL", 0, 0, "Vehicle.Revolute_FL", "", false,
  ...
  { "sm_vehicle_vtk/Vehicle/Revolute FR", 0, 0, "Vehicle.Revolute_FR", "", false,
    "The parameter Rz/Velocity contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "sm_vehicle_vtk/Vehicle/Revolute RL", 0, 0, "Vehicle.Revolute_RL", "", false,
    "The parameter Rz/Velocity contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
  ...
  { "sm_vehicle_vtk/Vehicle/Revolute RR", 0, 0, "Vehicle.Revolute_RR", "", false,
    "The parameter Rz/Velocity contains an Inf value, which is not allowed.",
    "sm:model:evaluate:InvalidValueInf" },
