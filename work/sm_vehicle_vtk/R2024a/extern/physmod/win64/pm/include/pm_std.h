...
void pmf_hotlink(char* buffer, int bufferSize, const char* obj);

int pmf_vsnprintf_message(char* buffer, size_t l, const char* format, va_list arg);
...
real_T pmf_asin_nfp(real_T x);

real_T pmf_acos(real_T x);

real_T pmf_acos_nfp(real_T x);

real_T pmf_log(real_T x);

real_T pmf_log_nfp(real_T x);

real_T pmf_log10(real_T x);

real_T pmf_log10_nfp(real_T x);

real_T pmf_pow(real_T x, real_T y);

real_T pmf_pow_nfp(real_T x, real_T y);

real_T pmf_sqrt(real_T x);

real_T pmf_sqrt_nfp(real_T x);

real_T pmf_exp(real_T x);

real_T pmf_exp_nfp(real_T x);
