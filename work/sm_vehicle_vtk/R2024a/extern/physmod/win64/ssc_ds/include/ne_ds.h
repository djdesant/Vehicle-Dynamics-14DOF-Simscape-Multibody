...
extern "C" {
#endif /* __cplusplus */
typedef union NeDsMethodOutputTag{PmSparsityPattern mM_P;PmRealVector mM;
PmBoolVector mVMM;PmSparsityPattern mDXM_P;PmRealVector mDXM;PmSparsityPattern
mDDM_P;PmRealVector mDDM;PmSparsityPattern mDUM_P;PmRealVector mDUM;
PmSparsityPattern mDTM_P;PmRealVector mDTM;PmSparsityPattern mDPM_P;
PmRealVector mDPM;PmSparsityPattern mA_P;PmRealVector mA;PmSparsityPattern mB_P
;PmRealVector mB;PmSparsityPattern mC_P;PmRealVector mC;PmRealVector mF;
PmBoolVector mVMF;PmBoolVector mVPF;PmBoolVector mVSF;PmBoolVector mSLF;
...
mDPDXF_P;PmRealVector mDPDXF;PmSparsityPattern mDWF_P;PmRealVector mDWF;
PmSparsityPattern mTDUF_P;PmSparsityPattern mTDXF_P;PmSparsityPattern mDNF_P;
PmRealVector mDNF;PmBoolVector mDNF_V_X;PmRealVector mCER;PmRealVector mDXCER;
PmSparsityPattern mDXCER_P;PmRealVector mDDCER;PmSparsityPattern mDDCER_P;
PmRealVector mIC;PmRealVector mICR;PmIntVector mICR_IM;PmBoolVector mICR_ID;
PmBoolVector mICR_IL;PmRealVector mDXICR;PmSparsityPattern mDXICR_P;
PmRealVector mDDICR;PmSparsityPattern mDDICR_P;PmSparsityPattern mTDUICR_P;
...
PmRealVector mFREQS;PmRealVector mSOLVERHITS;PmSparsityPattern mMDUY_P;
...
PmBoolVector mNLDV;PmBoolVector mSCLV;PmRealVector mIMIN;PmRealVector mIMAX;
PmRealVector mDIMIN;PmRealVector mDIMAX;}NeDsMethodOutput;typedef enum
...
NE_DS_METHOD_DTM,NE_DS_METHOD_DPM_P,NE_DS_METHOD_DPM,NE_DS_METHOD_A_P,
NE_DS_METHOD_A,NE_DS_METHOD_B_P,NE_DS_METHOD_B,NE_DS_METHOD_C_P,NE_DS_METHOD_C
,NE_DS_METHOD_F,NE_DS_METHOD_VMF,NE_DS_METHOD_VPF,NE_DS_METHOD_VSF,
NE_DS_METHOD_SLF,NE_DS_METHOD_SLF0,NE_DS_METHOD_DXF_P,NE_DS_METHOD_DXF,
NE_DS_METHOD_DUF_P,NE_DS_METHOD_DUF,NE_DS_METHOD_DTF_P,NE_DS_METHOD_DTF,
NE_DS_METHOD_DDF_P,NE_DS_METHOD_DDF,NE_DS_METHOD_DPDXF_P,NE_DS_METHOD_DPDXF,
NE_DS_METHOD_DWF_P,NE_DS_METHOD_DWF,NE_DS_METHOD_TDUF_P,NE_DS_METHOD_TDXF_P,
NE_DS_METHOD_DNF_P,NE_DS_METHOD_DNF,NE_DS_METHOD_DNF_V_X,NE_DS_METHOD_CER,
NE_DS_METHOD_DXCER,NE_DS_METHOD_DXCER_P,NE_DS_METHOD_DDCER,
NE_DS_METHOD_DDCER_P,NE_DS_METHOD_IC,NE_DS_METHOD_ICR,NE_DS_METHOD_ICR_IM,
...
NE_DS_METHOD_DDICRM,NE_DS_METHOD_FREQS,NE_DS_METHOD_SOLVERHITS,
