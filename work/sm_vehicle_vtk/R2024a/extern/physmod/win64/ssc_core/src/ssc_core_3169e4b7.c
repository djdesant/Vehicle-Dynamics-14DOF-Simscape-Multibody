...
ssc_core_FNXCmS38tFlnW5HGhPIM6s(NeSystemInputSizes sizes,PmAllocator*
...
#include "ne_std.h"
#include "ne_std.h"
struct ssc_core_V3scVTYpjYthiPB7SQIxc_{PmIntVector*
...
ssc_core_FeUzPe0YQn4rca7KjD_v4G->mData;if(mc__d1alWYexptL_X5HTFhbNK->
ssc_core_FbdZnMFCJSKiWiU7o8qdCq){ssc_core_V9uAItqbMYS0dHXy8Z61XW=true;
mc__d1alWYexptL_X5HTFhbNK->ssc_core_FbdZnMFCJSKiWiU7o8qdCq=false;
pm_VeeoZXnlJQ4u_112lGs8YD(mc__d1alWYexptL_X5HTFhbNK->
ssc_core_FWvlhwEdzo8FX5cXHNYbzI,&mc_kDRphcAfRHSbf1ZLKEDW9k->mQ);
pm_rv_equals_rv(mc__d1alWYexptL_X5HTFhbNK->ssc_core_FGXONvWx__hUeHAao3qmQB,&
mc_kDRphcAfRHSbf1ZLKEDW9k->mD);}else if(!pm_V8yYQkcd0vp_YaLM_nd75E(
mc__d1alWYexptL_X5HTFhbNK->ssc_core_FWvlhwEdzo8FX5cXHNYbzI,&
mc_kDRphcAfRHSbf1ZLKEDW9k->mQ)||!pm_FltUsml2sTlHZuCkbw_pdM(
mc__d1alWYexptL_X5HTFhbNK->ssc_core_FGXONvWx__hUeHAao3qmQB,&
mc_kDRphcAfRHSbf1ZLKEDW9k->mD)){ssc_core_V9uAItqbMYS0dHXy8Z61XW=true;
pm_VeeoZXnlJQ4u_112lGs8YD(mc__d1alWYexptL_X5HTFhbNK->
ssc_core_FWvlhwEdzo8FX5cXHNYbzI,&mc_kDRphcAfRHSbf1ZLKEDW9k->mQ);
pm_rv_equals_rv(mc__d1alWYexptL_X5HTFhbNK->ssc_core_FGXONvWx__hUeHAao3qmQB,&
mc_kDRphcAfRHSbf1ZLKEDW9k->mD);}return ssc_core_V9uAItqbMYS0dHXy8Z61XW;}static
void ssc_core_VKp00NftRMt9VHXCrTxU2Z(const ssc_core__SHoBDzmLMOwaLvvD5hSet*
ssc_core_FeUzPe0YQn4rca7KjD_v4G){boolean_T ssc_core_V9uAItqbMYS0dHXy8Z61XW=
false;ssc_core_FlZrG1BcKjtGV1aBRQ0fZ8*mc__d1alWYexptL_X5HTFhbNK=
...
ssc_core_Ff9S1xA4Ip4ZXeljM4_eEa;pm_destroy_int_vector(
mc__d1alWYexptL_X5HTFhbNK->ssc_core_FWvlhwEdzo8FX5cXHNYbzI,
...
mc__d1alWYexptL_X5HTFhbNK->ssc_core_FWvlhwEdzo8FX5cXHNYbzI=
pm_create_int_vector(sizes.mSizes[NE_SYSTEM_INPUT_ID_Q],
pm_FbYb_iLqY2hwZTVlVaiqJY);mc__d1alWYexptL_X5HTFhbNK->
ssc_core_FGXONvWx__hUeHAao3qmQB=pm_create_real_vector(sizes.mSizes[
NE_SYSTEM_INPUT_ID_D],pm_FbYb_iLqY2hwZTVlVaiqJY);mc__d1alWYexptL_X5HTFhbNK->
...
ssc_core_FeUzPe0YQn4rca7KjD_v4G->mDestroy=ssc_core_VhM6LeTCpVKS_9UnRhu_KK;
ssc_core_FeUzPe0YQn4rca7KjD_v4G->mData=mc__d1alWYexptL_X5HTFhbNK;return
