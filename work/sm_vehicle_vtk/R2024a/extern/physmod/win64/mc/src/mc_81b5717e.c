...
void*mc_V1pxxydYEnWVVi3QKesjvf,void*x,int32_T mc__suOgr_4PeCIZi_uhoSVwf);void*
mc_ktrY1jmEuvhTfeGflVz93o(int32_T n,size_t size){return(malloc((((n)>(1))?(n):
(1))*size));}void*mc_VInfIQCul4ShdLlbU4F0WB(int32_T n,size_t size){return(
calloc((((n)>(1))?(n):(1)),size));}void*mc__Mim_3QMMSxfi9M5sbbxcM(void*
pm__lqjegyKuwStj56WZLiC_e){if(pm__lqjegyKuwStj56WZLiC_e){free(
pm__lqjegyKuwStj56WZLiC_e);}return(NULL);}void*mc_k0mbD5QrRepqjLd_9sSyDz(void*
pm__lqjegyKuwStj56WZLiC_e,int32_T n,size_t size,int32_T*
mc__suOgr_4PeCIZi_uhoSVwf){void*mc__JpKaDRt0t_8c962AwrLr0;
mc__JpKaDRt0t_8c962AwrLr0=realloc(pm__lqjegyKuwStj56WZLiC_e,(((n)>(1))?(n):(1)
)*size);*mc__suOgr_4PeCIZi_uhoSVwf=(mc__JpKaDRt0t_8c962AwrLr0!=NULL);return((*
mc__suOgr_4PeCIZi_uhoSVwf)?mc__JpKaDRt0t_8c962AwrLr0:pm__lqjegyKuwStj56WZLiC_e
);}
