...
int32_T mc_Vux1rLMHdIOwYHo_GgP0nf(const int32_T*pm__lqjegyKuwStj56WZLiC_e,
const double*b,double*x,int32_T n){int32_T mc_V2__YrimeI4E_yWnhKofpy;if(!x||!b
){return(0);}for(mc_V2__YrimeI4E_yWnhKofpy=0;mc_V2__YrimeI4E_yWnhKofpy<n;
mc_V2__YrimeI4E_yWnhKofpy++){x[pm__lqjegyKuwStj56WZLiC_e?
pm__lqjegyKuwStj56WZLiC_e[mc_V2__YrimeI4E_yWnhKofpy]:mc_V2__YrimeI4E_yWnhKofpy
]=b[mc_V2__YrimeI4E_yWnhKofpy];}return(1);}
