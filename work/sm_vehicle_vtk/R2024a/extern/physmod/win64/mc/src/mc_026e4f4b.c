...
mc_kg4CyRgbu6OdeewZOel7Qx);void mc_kkqzb7EMLYWrdyRinsR_5h(const char*name,
const McMatrixFunction*mc_Fe6copTTRcKEayCm87ABO_){PmAllocator*
mc_FZx3iFiX1YW7j5eEojoAPc=pm_default_allocator();PmRealVector*
...
mc_ko6_hiERTRldgDROOJBQCH));mc__QFp_Gwyen4pg5YWQYpO3H(name,
mc_VlnhKi82gfCLgumIqeduOq,mc_Fe6copTTRcKEayCm87ABO_->mc_kjWUPQN_Ui4d_enzFJIsF_
);pm_destroy_real_vector(mc_VlnhKi82gfCLgumIqeduOq,mc_FZx3iFiX1YW7j5eEojoAPc);
}
