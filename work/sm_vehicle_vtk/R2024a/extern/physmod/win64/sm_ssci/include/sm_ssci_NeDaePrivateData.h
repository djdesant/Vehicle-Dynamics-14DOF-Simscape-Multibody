...
mEquationsPerConstraint;SmIntVector mHasAllVelocityDisabledEquations;
SmIntVector mRunTimeEnabledEquations;SmSizeTVector mDofToVelSlot;SmSizeTVector
...
const double*motionData,double*stateVector);void(*mComputeDiscreteState)(const
void*mech,const struct RuntimeDerivedValuesBundleTag*
runtimeDerivedValuesBundle,const int*modeVector,double*stateVector);void(*
mAdjustPosition)(const void*mech,const double*dofDeltas,double*stateVector);
void(*mPerturbJointPrimitiveState)(const void*mech,size_t stageIdx,size_t
...
stateVector,double*motionData);size_t(*mComputeAssemblyPosError)(const void*
mech,const struct RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,
size_t constraintIdx,const int*modeVector,const double*motionData,double*error
...
boolean_T forVelocitySatisfaction,const double*stateVector,const int*
modeVector,const double*motionData,double*J);size_t(*
mComputeFullAssemblyJacobian)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const double*
stateVector,const int*modeVector,const double*motionData,double*J);boolean_T(*
mIsInKinematicSingularity)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,size_t constraintIdx,
const int*modeVector,const double*motionData);void(*mConvertStateVector)(const
void*asmMech,const struct RuntimeDerivedValuesBundleTag*
asmRuntimeDerivedValuesBundle,const void*simMech,const double*asmStateVector,
const int*asmModeVector,const int*simModeVector,double*simStateVector);void(*
mConstructStateVector)(const void*mech,const double*solverStateVector,const
double*u,const double*uDot,const double*discreteStateVector,double*
fullStateVector);void(*mExtractSolverStateVector)(const void*mech,const double
*fullStateVector,double*solverStateVector);void(*mExtractDiscreteStateVector)(
const void*mech,const double*fullStateVector,double*discreteStateVector);
boolean_T(*mIsPositionViolation)(const void*mech,const struct
...
boolean_T(*mIsVelocityViolation)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*
constraintEqnEnableFlags,const double*stateVector,const int*modeVector);
PmfMessageId(*mProjectStateSim)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*
constraintEqnEnableFlags,const int*modeVector,double*stateVector,void*
neDiagMgr);void(*mComputeConstraintError)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const double*
stateVector,const int*modeVector,double*error);void(*mResetModeVector)(const
void*mech,int*modeVector);boolean_T(*mHasJointUpwardModeChange)(const void*
mech,const int*prevModeVector,const int*modeVector);PmfMessageId(*
mPerformJointUpwardModeChange)(const void*mech,const struct
RuntimeDerivedValuesBundleTag*runtimeDerivedValuesBundle,const int*
constraintEqnEnableFlags,const int*prevModeVector,const int*modeVector,const
double*inputVector,double*stateVector,void*neDiagMgr);void(*
mOnModeChangedCutJoints)(const void*mech,const int*prevModeVector,const int*
modeVector,double*stateVector);void(*mSetVariableModeJointsToLocked)(const void
*mech,int*modeVector);const void*mMech;};typedef struct SmMechanismDelegateTag
SmMechanismDelegate;struct SmMechanismDelegateScratchpadTag{SmBoundedSet
mPosRequired,mPosDesired,mPosSuggested,mPosFree,mPosNonRequired,
mPosSuggAndFree;SmBoundedSet mVelRequired,mVelDesired,mVelSuggested,mVelFree,
mVelNonRequired,mVelSuggAndFree;SmBoundedSet mConstraintFilter;SmBoundedSet
mActiveConstraints,mActiveDofs0,mActiveDofs;SmBoundedSet mNewConstraints,
mNewDofs;SmBoundedSet mUnsatisfiedConstraints;SmSizeTVector
mActiveConstraintsVect,mActiveDofsVect;SmSizeTVector mFullDofToActiveDof;
SmSizePairVector mPartiallyPosTargetedPrims;SmSizePairVector
mPartiallyVelTargetedPrims;SmSizeTVector mPosPartialTypes;SmSizeTVector
mVelPartialTypes;SmSizeTVector mPartiallyActivePrims;SmSizePairVector
mBaseFrameVelOffsets;SmSizePairVector mCvQuaternionVelOffsets;SmRealVector
mCvQuaternionAzimuthValues;SmRealVector mInitialState;SmRealVector mStartState
;SmRealVector mTestState;SmRealVector mFullStateVector;SmIntVector mModeVector
;SmRealVector mJacobianRowMaj;SmRealVector mJacobian;SmRealVector
...
SmMechanismDelegate*delegate);void sm_core_computeStateVector(const
...
struct CTargetTag*cTargets,double*stateVector);void
...
double*stateVector);unsigned int sm_core_checkAssembly(const
SmMechanismDelegate*mechDelegate,const struct RuntimeDerivedValuesBundleTag*
...
double*inputVector,const double*inputDotVector,const int*prevModeVector,const
int*modeVector,double*solverStateVector,double*discreteStateVector,void*
neDiagMgr);struct RuntimeDerivedValuesBundleTag{SmRealVector mDoubles;
SmIntVector mInts;};typedef struct RuntimeDerivedValuesBundleTag
...
mOutputVectorSize;size_t mNumConstraintEqns;real_T mFundamentalSampleTime;
...
mNumMotionInputPrimitives;size_t mNumLockablePrimitives;size_t mNumTargets;
PmIntVector mStateVectorMap;struct CTargetTag*mTargets;CStateManager*
mStateManager;size_t mNumParamAsserts;PmCharVector*mParamAssertObjects;
PmCharVector*mParamAssertPaths;PmCharVector*mParamAssertDescriptors;
PmCharVector*mParamAssertMessages;PmCharVector*mParamAssertMessageIds;
PmBoolVector mParamAssertIsWarnings;PmIntVector mAssemblyModeVector;
PmIntVector mCachedModeVector;PmCharVector*mZeroCrossingObjects;PmCharVector*
mZeroCrossingPaths;PmCharVector*mZeroCrossingDescriptors;PmIntVector
mZeroCrossingTypes;size_t mNumVarScalars;PmCharVector*mVarFullPaths;
PmCharVector*mVarObjects;PmCharVector*mVarEncodedDims;PmSizeVector mVarNumels;
size_t mNumRtpRootVars;PmIntVector mRtpRootVarNumels;PmCharVector*
...
;PmCharVector*mInputPortPaths;PmCharVector*mInputUnits;SscIoInfo*mInputInfos;
size_t mNumOutputs;PmCharVector*mOutputPortPaths;PmCharVector*mOutputUnits;
SscIoInfo*mOutputInfos;PmIntVector mNumInputDerivs;size_t mInputOrder;
...
SmMechanismDelegateTag mAssemblyDelegate,mSimulationDelegate;PmSizeVector
mMotionInputOffsets;PmBoolVector mLockablePrimHasModes;PmSizeVector
mLockablePrimModeOffsets;NeDaeSetParameters mSetParametersFcn;NeDaeMethod
...
mSetupLoggerFcn)(const NeDae*,NeLoggerBuilder*);PmfMessageId(*mLogFcn)(const
NeDae*,const NeSystemInput*,PmRealVector*,NeuDiagnosticManager*);
NeDaeLinearizeFcn mResidualsFcn;NeDaeLinearizeFcn mLinearizeFcn;void(*
mGenerateFcn)(const NeDae*,const NeCgParams*,NeCgResults*);struct LiveSmLink*
mLiveSmLink;void(*mLiveSmLink_destroy)(struct LiveSmLink*link);struct
LiveSmLink*(*mLiveSmLink_copy)(const struct LiveSmLink*orig);};
#ifdef __cplusplus
}
#endif /* __cplusplus */
