...
void sm_vehicle_vtk_836bb176_1_setTargets(const RuntimeDerivedValuesBundle *rtdv,
  CTarget *targets)
{
...
void sm_vehicle_vtk_836bb176_1_initializeTrackedAngleState(const void *mech,
...
void sm_vehicle_vtk_836bb176_1_computeDiscreteState(const void *mech, const
...
void sm_vehicle_vtk_836bb176_1_adjustPosition(const void *mech, const double
...
void sm_vehicle_vtk_836bb176_1_perturbAsmJointPrimitiveState(const void *mech,
...
void sm_vehicle_vtk_836bb176_1_computePosDofBlendMatrix(const void *mech, size_t
...
void sm_vehicle_vtk_836bb176_1_computeVelDofBlendMatrix(const void *mech, size_t
  stageIdx, size_t primIdx, const double *state, int partialType, double *matrix)
{
  (void) mech;
  (void) stageIdx;
...
void sm_vehicle_vtk_836bb176_1_projectPartiallyTargetedPos(const void *mech,
...
void sm_vehicle_vtk_836bb176_1_propagateMotion(const void *mech, const
  RuntimeDerivedValuesBundle *rtdv, const double *state, double *motionData)
{
  ...
  xx[48] = xx[24] * cos(xx[22]);
  xx[49] = xx[24] * sin(xx[22]);
  xx[22] = xx[48] - xx[49];
  xx[50] = xx[48] + xx[49];
  xx[51] = - xx[50];
  xx[52] = xx[48] + xx[49];
  ...
  xx[49] = xx[48] * xx[52];
  xx[55] = xx[48] * xx[54];
  xx[56] = - ((xx[49] * xx[52] + xx[55] * xx[54]) * xx[32] - xx[48]);
  xx[48] = (xx[22] * xx[55] + xx[50] * xx[49]) * xx[32];
  xx[52] = - (0.05000000000000002 + xx[32] * (xx[50] * xx[55] - xx[22] * xx[49]));
  xx[49] = xx[24] * state[29];
  xx[50] = - (xx[39] * cos(xx[49]));
  xx[55] = - (xx[39] * sin(xx[49]));
...
size_t sm_vehicle_vtk_836bb176_1_computeAssemblyPosError(const void *mech, const
...
size_t sm_vehicle_vtk_836bb176_1_computeAssemblyJacobian(const void *mech, const
...
size_t sm_vehicle_vtk_836bb176_1_computeFullAssemblyJacobian(const void *mech,
...
boolean_T sm_vehicle_vtk_836bb176_1_isInKinematicSingularity(const void *mech,
...
void sm_vehicle_vtk_836bb176_1_convertStateVector(const void *asmMech, const
